    ...
    <div className="min-h-screen bg-charcoal text-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="text-center max-w-2xl">
          <h1 className="hero-headline font-normal mb-6 leading-tight">Portfolio Coming Soon</h1>
          <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-lg mx-auto font-normal">
