...
export default function HouseSoftWashHero() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/quote", {
        ...
        body: JSON.stringify({
          ...formData,
          _subject: "New House Soft Wash Quote Request",
        }),
      })
  ...
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/HouseHero.jpg-GrO5BiwfpZvQQF1blnJ6WefGwtN5Z9.jpeg')",
      }}
    >
      ...
      <div className="relative z-10 container grid lg:grid-cols-5 gap-12 items-center">
        ...
        <div className="text-center lg:text-left lg:col-span-3">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4">
            Refresh Your Home's Exterior With Safe, Effective Soft Washing
          </h1>
          <p className="text-lg md:text-xl mb-8 max-w-2xl">
            Protect your siding and boost curb appeal with Portland's trusted low-pressure cleaning experts.
          </p>
        ...
        <div className="lg:col-span-2 lg:ml-8">
          ...
          >
            <h3 className="text-xl font-bold mb-4 text-white">Get a Free House Cleaning Quote</h3>
            <form onSubmit={handleSubmit} className="space-y-4">
              <input type="hidden" name="_subject" value="New House Soft Wash Quote Request" />
              ...
              <button
                ...
                disabled={formState === "submitting"}
              >
                {formState === "submitting" ? "Submitting..." : "Get Free House Cleaning Quote"}
              </button>
            </form>
