    ...
    <section className="py-16" style={{ backgroundColor: "#D1D5DB" }}>
      <div className="container">
        <div className="text-center mb-12">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-navy">Save More With Service Bundles</h2>
        ...
        <div className="text-center max-w-2xl mx-auto">
          <p className="text-gray-700">
            Combine your house soft washing with other exterior services and enjoy discounted pricing. Popular bundles
            include siding, roof, driveway, and gutters. One visit, one professional team, a completely refreshed home.
          </p>
        </div>
      </div>
    </section>
