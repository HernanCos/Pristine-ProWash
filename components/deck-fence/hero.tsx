  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/quote", {
        ...
        body: JSON.stringify({
          ...formData,
          _subject: "New Deck & Fence Cleaning Quote Request from PristineProWash",
        }),
      })
  ...
  return (
    <section className="relative min-h-screen flex items-center -mt-px">
      <div className="absolute inset-0 z-0">
        <Image
          src="/Deck&Fence.png"
          alt="Professional deck and fence cleaning service in action"
          fill
      ...
      <div className="container relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-white text-center lg:text-left lg:pl-8">
          <h1 className="text-4xl md:text-5xl lg:text-[3.2rem] font-bold mb-4 leading-tight">
            Deck & Fence Cleaning That Restores Natural Beauty
          </h1>
          <p className="text-xl md:text-2xl lg:text-3xl mb-8 max-w-2xl">
            Restore natural wood color, prevent algae damage, and protect your outdoor spaces.
          </p>
        ...
        >
          <h3 className="text-xl font-bold mb-4 text-white">Get a Free Deck & Fence Cleaning Quote</h3>
          <form onSubmit={handleSubmit} className="space-y-4">
            <input type="hidden" name="_subject" value="New Deck & Fence Cleaning Quote Request from PristineProWash" />
            <input type="hidden" name="service" value="deck" />

            <div>
              <label htmlFor="deck-name" className="block mb-1 text-sm font-medium text-gray-200">
                Full Name
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="deck-email" className="block mb-1 text-sm font-medium text-gray-200">
                Email Address
              </label>
              <input
                type="email"
            ...
            <div>
              <label htmlFor="deck-phone" className="block mb-1 text-sm font-medium text-gray-200">
                Phone Number
              </label>
              <input
                type="tel"
            ...
            <div>
              <label htmlFor="deck-address" className="block mb-1 text-sm font-medium text-gray-200">
                Property Address
              </label>
              <input
                type="text"
            ...
            <button
              ...
              disabled={formState === "submitting"}
            >
              {formState === "submitting" ? "Submitting..." : "Get Free Deck & Fence Cleaning Quote"}
            </button>
          </form>
