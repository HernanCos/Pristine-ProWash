    ...
    <section className="py-16" style={{ backgroundColor: "#D1D5DB" }}>
      <div className="container">
        <h2 className="text-2xl md:text-3xl font-bold text-navy text-center mb-12">
          Why Deck & Fence Cleaning Matters
        </h2>
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              ...
              professional cleaning helps homeowners protect their investment and enjoy a more attractive outdoor space.
            </p>
            ...
            <p>
              ...
              causing cracks, splintering, and fading. This combination of moisture and sun exposure is especially hard
              on untreated or older wood surfaces.
            </p>
            ...
            <p>
              ...
              the risks of long-term damage. A clean deck and fence do more than improve your home's appearance. Regular
              cleaning extends the life of outdoor structures, keeps them safer to use, and ensures they remain a
              welcoming part of your outdoor living space for years to come.
            </p>
          </div>
        </div>
      </div>
