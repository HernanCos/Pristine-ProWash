  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/quote", {
        ...
        body: JSON.stringify({
          ...formData,
          _subject: "New Roof Soft Wash Quote Request from PristineProWash",
        }),
      })
  ...
  return (
    <section className="relative min-h-screen flex items-center -mt-px">
      <div className="absolute inset-0 z-0">
        <Image
          src="/images/RoofHero.jpg"
          alt="Professional roof soft washing service in action"
          fill
      ...
      <div className="container relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-white text-center lg:text-left lg:pl-8">
          ...
          <p className="text-xl md:text-2xl lg:text-3xl mb-8 max-w-2xl">
            Safe moss removal without roof damage. Plant-safe solutions, licensed & insured.
          </p>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <input type="hidden" name="_subject" value="New Roof Soft Wash Quote Request from PristineProWash" />
            <input type="hidden" name="service" value="roof" />

            <div>
              <label htmlFor="roof-name" className="block mb-1 text-sm font-medium text-gray-200">
                Full Name
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="roof-email" className="block mb-1 text-sm font-medium text-gray-200">
                Email Address
              </label>
              <input
                type="email"
            ...
            <div>
              <label htmlFor="roof-phone" className="block mb-1 text-sm font-medium text-gray-200">
                Phone Number
              </label>
              <input
                type="tel"
            ...
            <div>
              <label htmlFor="roof-address" className="block mb-1 text-sm font-medium text-gray-200">
                Property Address
              </label>
              <input
                type="text"
